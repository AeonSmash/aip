...
| [`examples/main-breaker.aip.json`](examples/main-breaker.aip.json) | Example event from the web CRT switch |
...
| [`mappings/unreal-fps.json`](mappings/unreal-fps.json) | Destination-owned FPS rules (LinkBeam unlock) |
...
**Prototype / in development — playable one-tower Unreal reference (presentation 0.5.1).**

- TypeScript core validates and maps envelopes (`npm test` green); `@aeonsmash/aip` **0.5.1**
